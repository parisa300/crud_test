...
class _CustomerScreenState extends State<CustomerScreen> {
  ...
  bool _isValid = false;
  final TextEditingController birthdateController = TextEditingController(text: ' ');
   ...
   return BlocBuilder<CustomerBloc,CustomerState>(
      ...
      builder: (context, state){
        ...
        if (state.getAllCustomerStatus is GetAllCustomerCompleted) {
         ...
         GetAllCustomerCompleted getAllCustomerCompleted = state.getAllCustomerStatus as GetAllCustomerCompleted;
         ...
         return  SafeArea(
              child: Scaffold(
                ...
                floatingActionButton: FloatingActionButton(
                  ...
                  onPressed: ()async{
                    String firstName = (await _asyncInputDialog(context)) as String;
                    String lastName = (await _asyncInputDialog(context)) as String;
                    String date = (await _asyncInputDialog(context)) as String;
                    String phoneNumber = (await _asyncInputDialog(context)) as String;
                    String email = (await _asyncInputDialog(context)) as String;
                    String cardNumber = (await _asyncInputDialog(context)) as String;
                  //  _asyncInputDialog(context);
                    var patient = CustomerEntity(firstName: firstName, lastName: lastName, dateOfBirth: date, phoneNumber: phoneNumber, email: email, bankAccountNumber: cardNumber);
              ...
              //   CustomerButtonClick( params: params!)
                 ...
                 CustomButton(
                   ...
                   onPressed: () {
                     ...
                     if (firstName.isNotEmpty && lastName.isNotEmpty /*& phoneNumber.isNotEmpty && cardNumber.isNotEmpty && date.isNotEmpty*/) {
